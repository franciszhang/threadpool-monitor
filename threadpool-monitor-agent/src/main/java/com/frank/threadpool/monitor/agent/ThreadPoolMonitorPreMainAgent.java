package com.frank.threadpool.monitor.agent;


import com.frank.threadpool.monitor.agent.interceptor.ThreadPoolRejectInterceptor;
import com.frank.threadpool.monitor.agent.interceptor.ThreadPoolConstructorInterceptor;
...
public class ThreadPoolMonitorPreMainAgent {
    ...
    private static final String AGENT_MANAGER_PATH = findAgentPath() + "/threadpool-monitor-agent-manager-1.0.0.jar";

    public static void premain(String agentArgs, Instrumentation inst) {
        try {
            inst.appendToBootstrapClassLoaderSearch(new JarFile(AGENT_MANAGER_PATH));
